...
public class SacCommand extends SubCommand {
    public SacCommand() {
        super("sac", "Sacar dinheiro do banco", EconomiaCommand.class);
    }
    ...
    public void perform(SlashCommandInteractionEvent evt, OptionMapping args) {
        ...
        eb.setTitle("\uD83D\uDC77 Money");
        eb.setDescription("> O: <@" + evt.getUser().getId() + "> sacou " + quant + " no banco.");
